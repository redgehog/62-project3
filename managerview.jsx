...
export default function ManagerView() {
  ...
  const toggleMenu = (id) => setInventory((prev) => prev.map((i) => i.id === id ? { ...i, onMenu: !i.onMenu } : i));
          ...
          {activeTab === "Inventory" && (
            <>
              ...
              <div style={{ display: "flex", gap: "8px", marginBottom: "24px" }}>
                ...
                <button onClick={() => selected && toggleMenu(selected)} style={actionBtn}>Add to menu</button>
                <button onClick={() => selected && toggleMenu(selected)} style={actionBtn}>Remove from menu</button>
              </div>
...
const th = { padding: "8px 12px", border: "1px solid #ccc", textAlign: "left", fontWeight: "600" };
const td = { padding: "8px 12px", border: "1px solid #ccc" };
const actionBtn = { padding: "6px 14px", border: "1px solid #ccc", background: "#f0f0f0", cursor: "pointer", fontSize: "13px" };
const inputStyle = { padding: "4px 8px", border: "1px solid #ccc", fontSize: "13px", width: "120px" };
